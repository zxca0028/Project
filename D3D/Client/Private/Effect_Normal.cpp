...
CEffect_Normal::CEffect_Normal(LPDIRECT3DDEVICE9 pGraphic_Device)
	: CBlender(pGraphic_Device)
{}

CEffect_Normal::CEffect_Normal(const CEffect_Normal& rhs)
	: CBlender(rhs)
{}

HRESULT CEffect_Normal::NativeConstruct_Prototype()
{
...
HRESULT CEffect_Normal::NativeConstruct(void* pArg)
{
...
_int CEffect_Normal::Tick(_double TimeDelta)
{
	__super::Tick(TimeDelta);

	m_fFrame += 15.f * TimeDelta * 3.f;
...
_int CEffect_Normal::Late_Tick(_double TimeDelta)
{
...
HRESULT CEffect_Normal::Set_ConstTable()
{
...
HRESULT CEffect_Normal::Add_Components()
{
	...
	if (FAILED(CGameObject::Add_Component(LEVEL_GAMEPLAY, TEXT("Prototype_Texture_Normal"), TEXT("Com_Texture"),   (CComponent**)&m_pTexture)))  { return E_FAIL; }

	return S_OK;
}

CEffect_Normal* CEffect_Normal::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CEffect_Normal* pInstance = new CEffect_Normal(pGraphic_Device);
...
CGameObject* CEffect_Normal::Clone(void* pArg)
{
	CEffect_Normal* pInstance = new CEffect_Normal(*this);
