...
CEffect_Electric::CEffect_Electric(LPDIRECT3DDEVICE9 pGraphic_Device)
	: CBlender(pGraphic_Device)
{}

CEffect_Electric::CEffect_Electric(const CEffect_Electric& rhs)
	: CBlender(rhs)
{}

HRESULT CEffect_Electric::NativeConstruct_Prototype()
{
...
HRESULT CEffect_Electric::NativeConstruct(void* pArg)
{
...
_int CEffect_Electric::Tick(_double TimeDelta)
{
	__super::Tick(TimeDelta);

	m_fFrame += 8.f * TimeDelta * 3.f;
...
_int CEffect_Electric::Late_Tick(_double TimeDelta)
{
...
HRESULT CEffect_Electric::Render()
{
...
HRESULT CEffect_Electric::Set_ConstTable()
{
...
HRESULT CEffect_Electric::Add_Components()
{
	...
	if (FAILED(CGameObject::Add_Component(LEVEL_GAMEPLAY, TEXT("Prototype_Texture_Electric"), TEXT("Com_Texture"), (CComponent**)&m_pTexture))) { return E_FAIL; }

	return S_OK;
}

CEffect_Electric* CEffect_Electric::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CEffect_Electric* pInstance = new CEffect_Electric(pGraphic_Device);
...
CGameObject* CEffect_Electric::Clone(void* pArg)
{
	CEffect_Electric* pInstance = new CEffect_Electric(*this);
