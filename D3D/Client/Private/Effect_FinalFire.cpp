...
CEffect_FinalFire::CEffect_FinalFire(LPDIRECT3DDEVICE9 pGraphic_Device)
	: CBlender(pGraphic_Device)
{}

CEffect_FinalFire::CEffect_FinalFire(const CEffect_FinalFire& rhs)
	: CBlender(rhs)
{}

HRESULT CEffect_FinalFire::NativeConstruct_Prototype()
{
...
HRESULT CEffect_FinalFire::NativeConstruct(void* pArg)
{
...
_int CEffect_FinalFire::Tick(_double TimeDelta)
{
	__super::Tick(TimeDelta);

	m_fFrame += 35.f/ 2.f * TimeDelta;
...
_int CEffect_FinalFire::Late_Tick(_double TimeDelta)
{
...
HRESULT CEffect_FinalFire::Render()
{
...
HRESULT CEffect_FinalFire::Set_ConstTable()
{
...
HRESULT CEffect_FinalFire::Add_Components()
{
	...
	if (FAILED(CGameObject::Add_Component(LEVEL_GAMEPLAY, TEXT("Prototype_Texture_FinalFire"), TEXT("Com_Texture"), (CComponent**)&m_pTexture))) { return E_FAIL; }

	return S_OK;
}

CEffect_FinalFire* CEffect_FinalFire::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CEffect_FinalFire* pInstance = new CEffect_FinalFire(pGraphic_Device);
...
CGameObject* CEffect_FinalFire::Clone(void* pArg)
{
	CEffect_FinalFire* pInstance = new CEffect_FinalFire(*this);
