...
CEffect_Spark::CEffect_Spark(LPDIRECT3DDEVICE9 pGraphic_Device)
	: CBlender(pGraphic_Device)
{}

CEffect_Spark::CEffect_Spark(const CEffect_Spark& rhs)
	: CBlender(rhs)
{}

HRESULT CEffect_Spark::NativeConstruct_Prototype()
{
...
HRESULT CEffect_Spark::NativeConstruct(void* pArg)
{
...
_int CEffect_Spark::Tick(_double TimeDelta)
{
	__super::Tick(TimeDelta);

	m_fFrame += 4.f * TimeDelta * 3.f;
...
_int CEffect_Spark::Late_Tick(_double TimeDelta)
{
...
HRESULT CEffect_Spark::Set_ConstTable()
{
...
HRESULT CEffect_Spark::Add_Components()
{
	...
	if (FAILED(CGameObject::Add_Component(LEVEL_GAMEPLAY, TEXT("Prototype_Texture_Spark"), TEXT("Com_Texture"), (CComponent**)&m_pTexture))) { return E_FAIL; }

	return S_OK;
}

CEffect_Spark* CEffect_Spark::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CEffect_Spark* pInstance = new CEffect_Spark(pGraphic_Device);
