...
class CGhost_Soldier final : public CGameObject
{
public:
...
private:
	...
	explicit CGhost_Soldier(LPDIRECT3DDEVICE9 pGraphic_Device);
...
private:
	...
	_float m_fDamage = 300.f;

	_bool m_bMotionLock = false;

public:

	static  CGhost_Soldier* Create(LPDIRECT3DDEVICE9 pGraphic_Device);
