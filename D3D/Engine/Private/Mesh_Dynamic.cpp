...
HRESULT CMesh_Dynamic::Set_TextureOnShader(CShader* pShader, D3DXHANDLE hParameter, MESHMATERIALTEXTURE::TYPE eType, _uint iMeshContainerIndex, _uint iMaterialIndex)
{
    ...
    if (FAILED(pShader->Set_TextureConstTable(hParameter, pTexture)))
    {
        return E_FAIL;
    }
